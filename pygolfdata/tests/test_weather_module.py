...
class WeatherDateApiTest(unittest.TestCase):
    ...
    """
    #valid_file_path = "weather/test_data/weather_date_api_test.csv"
    existing_valid_file_path = "E:\Data\data_515\etest.csv"
    non_existing_valid_file_path = "E:\Data\data_515\esdfs.csv"
    invalid_file_path = "weather/test_data/BAD_DIRECTORY/weather_date_api_test.csv"

    def setUp(self):
        self.wda = core.WeatherDateApi("TEST", self.existing_valid_file_path)
        self.wda2 = core.WeatherDateApi("TEST", self.non_existing_valid_file_path)
        self.df = self.wda.get_weather_dataframe()

    def test_invalid_file_path(self):
        """ Tests that the __init__ method throws a ValueError when given a bad file path
        """
        self.assertRaises(ValueError, core.WeatherDateApi, "", self.invalid_file_path)
    ...
    def test_set_api_key(self):
        ...
        """
        random_key = ''.join(random.choice(string.ascii_uppercase) for _ in range(10))
    ...
    def test_get_file_path(self):
        ...
        """
        self.assertEqual(self.existing_valid_file_path, self.wda.get_output_file_path())

    def test_set_file_path(self):
        """ Tests the file path set method
        """
        self.wda.set_output_file_path(self.non_existing_valid_file_path)
        self.assertEqual(self.non_existing_valid_file_path, self.wda.get_output_file_path())

    def test_set_invalid_file_path(self):
        """ Tests that the file path set method throws a ValueError when given a bad file path
        """
        self.assertRaises(ValueError, self.wda.set_output_file_path, self.invalid_file_path)
